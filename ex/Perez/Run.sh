...
mpiexec -n $np ./$ProgramDir$ProgramName -Input_type $InputType -Input_type_tplgy $InputTypeTplgy -Input_type_gmtry $InputTypeGmtry -Input_type_cvt $InputTypeCvt -Input_Dir $InputDir -Input_file_gmtry $InputFileGmtry -Input_file_cvt $InputFileCvt -Input_file_cvt_by_zones $InputFileCvtByZones -Input_file_tplgy $InputFileTplgy -Input_file_bc $InputFileBC -Output_type $OutputType -Output_dir $OutputDir -Run_options_scheme $Scheme 
